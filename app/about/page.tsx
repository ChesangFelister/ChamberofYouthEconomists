  ...
  return (
    <main className="flex-1">
      ...
      <section className="relative w-full h-[400px] overflow-hidden">
        ...
        ></div>
        <Image
          src="/economics-conference.png"
          alt="Economics conference"
          fill
        ...
        <div className="container mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="w-full md:w-1/2">
              <h2
                className="text-3xl md:text-4xl font-bold mb-6 text-emerald-800 dark:text-emerald-300"
                style={{ color: "#065f46" }}
              >
                Our Story
              </h2>
      ...
      {/* Values Section */}
      <section className="py-16 md:py-24 bg-slate-50 dark:bg-slate-900" style={{ backgroundColor: "#f8fafc" }}>
        <div className="container mx-auto px-6 md:px-8">
          <h2
            className="text-3xl md:text-4xl font-bold mb-12 text-center text-emerald-800 dark:text-emerald-300"
            style={{ color: "#065f46" }}
          >
            Our Core Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white dark:bg-slate-800 border-none shadow-lg">
              <CardContent className="p-6">
                <div
                  className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900 rounded-full flex items-center justify-center mb-4"
                ...
                <h3
                  className="text-xl font-bold mb-3 text-emerald-800 dark:text-emerald-300"
                  style={{ color: "#065f46" }}
                >
                  Excellence
                </h3>
        ...
        <div className="container mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3
                className="text-xl font-bold mb-1 text-emerald-800 dark:text-emerald-300"
                style={{ color: "#065f46" }}
              >
                Sarah Johnson
              </h3>
              <p className="text-amber-600 dark:text-amber-400 font-medium mb-3" style={{ color: "#d97706" }}>
                President
              </p>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 bg-emerald-900 text-white" style={{ backgroundColor: "#064e3b" }}>
        <div className="container mx-auto px-6 md:px-8 text-center">
          ...
          <Button
            asChild
            size="lg"
            className="bg-amber-400 hover:bg-amber-500 text-slate-900 font-bold px-8 py-6"
            style={{
